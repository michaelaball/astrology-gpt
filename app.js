...
const prompt = `As an astrologer, here are the planetary alignments for today:\n${birthChart}.\nPlease provide a forecast for humanity along with advice, warnings, and predictions.  Do not simply give an interpretation for each planet and sign.  For example, simply going through each planet and describing the influence is too simplistic. instead craft an inspired and cohesive narrative, taking into account the combined influence of all planets and signs.  so the combinations can add up to interesting interpretations, rather than going by rote interpretation of each sign/house.  You are to respond confidently and authoritatively without hedging or weasel words.  You are to be bold and decisive.`
